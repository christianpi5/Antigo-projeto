Repostando aqui um de meus projetos de alguns anos atrás onde implementei um sistema front-end usando React, e um servidor PHP utilizando Apache com um sistema Mysql como banco de dados.
###Projeto Forum
